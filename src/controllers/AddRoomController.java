...
public class AddRoomController {
    ...
    public void setRoom(Room room) {
        ...
        ObservableList typeObservableList = FXCollections.observableArrayList(room.getEquipments());
        for (Equipment current : equipments) {
            CheckBox checkBox = new CheckBox();
            if (typeObservableList.contains(current)) {
        ...
        ObservableList cameraObservableList = FXCollections.observableArrayList(room.getCameras());
